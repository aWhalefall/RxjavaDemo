package com.nuoyuan.rxdemo.category2_transforming_observables;
...
public class Category2Operator4GroupByActivity extends SampleTempActivity {
    ...
    protected void runSampleCode() {
        ...
        // 简化版
        Observable.just(1, 2, 3, 4, 5, 6, 9, 12)
                .groupBy(new Func1<Integer, Integer>() {
                    @Override
                    public Integer call(Integer integer) {
                        return integer % 3;
                    ...
                    public void call(final GroupedObservable<Integer, Integer> result) {
                        result.subscribe(new Action1<Integer>() {
                            ...
                            public void call(Integer integer) {
                                Log.d("GroupBy", "Key=" + result.getKey() + ", Value=" + integer);
                            }
                        });
                    }
                });
