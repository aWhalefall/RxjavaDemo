package com.nuoyuan.rxdemo.category6_observable_utility_operators;
...
public class Category6Operator1MaterializeActivity extends SampleTempActivity {
    ...
    protected void runSampleCode() {
        Observable.just(1, 2, 3, 4)  //== create(new OnSubscribeFromIterable<T>(iterable))
                .materialize() //转换成通知列表
